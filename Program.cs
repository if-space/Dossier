...
namespace Lessons
{
    class Program
    {
        ...
        static void AddDossier(ref string[] names, ref string[] positions)
        {
            ...
            names = IncreaseDossier(names, userName);
            positions = IncreaseDossier(positions, userPosition);
        }

        static string[] IncreaseDossier(string[] dossier, string newValue)
        {
            ...
            tempDossier[tempDossier.Length - 1] = newValue;
